...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠉⠉⢻⡏⠉⠉⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
""".replace("⠀", " ")  # Replace special blank characters with normal spaces
...
def main():
  ...
  ip = input(stage(f"IP TO GLOPPA IT{purple}->{fluo2} ", '?'))
  print()
  ...
  port = input(
      stage(
          f"port {purple}[{white}press {fluo2}enter{white} to attack all ports{purple}] {purple}->{fluo2} ",
          '?'))
  print()
  ...
  force = input(
      stage(
          f"Bytes per packet {purple}[{white}press {fluo2}enter{white} for 10gb/s{purple}] {purple}->{fluo2} ",
          '?'))
  print()
